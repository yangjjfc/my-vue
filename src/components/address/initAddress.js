export default {
    ...
    <div class="region-picker">
      <label class="province">
        ...
        <el-select v-model="value" :placeholder="placeholder.province" class="province-select" @change="change('provinceSelected', $event.target.value)" :required="required" :disabled="disabled">
            <el-option
