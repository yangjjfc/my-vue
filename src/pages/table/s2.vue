<template>
  <section>
    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-table ref="multipleTable" :data="tableDate" border tooltip-effect="dark" style="width: 100%">
          <el-table-column type="selection" width="55">
          </el-table-column>
          <el-table-column label="客户名称" width="120" prop="customerName">
  
          </el-table-column>
          <el-table-column prop="registNum" label="注册证" width="120">
          </el-table-column>
          <el-table-column prop="factoryNum" label="生产厂家" show-overflow-tooltip>
          </el-table-column>
