<template>
    <section>
        <dailog size="tiny" :show.sync="myshow" classx="change-name" title="修改邮箱" @ok="quire" @reset="reset">
            <el-form slot="content"  :rules="rules" label-width="100px" ref="forms" class="demo-dynamic" :model="msgx">
                ...
                <el-form-item label="新邮箱" prop="email">
                    ...
                    <el-button @click.prevent="sendCode" type="info" :disabled="statex" size="small">发送验证码</el-button>
                </el-form-item>
        ...
        quire () {
            ...
            this.$refs.forms.validate((valid) => {
                ...
                if (!valid) {
                    ...
                    console.log(this.msgx.password, this.clientid, this.token);
